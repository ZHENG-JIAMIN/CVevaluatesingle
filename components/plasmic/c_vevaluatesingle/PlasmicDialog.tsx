...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: UAlURoLAAh46/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_f7i04eTDwN8s"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___3A3Y3)}
              >
                <div
                  className={classNames(
                    projectcss.all,
