...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: aOiy0GKOXQOH/css
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_j2WshU8OMrp1"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__cLCtb)}
              >
                <div
                  className={classNames(
                    projectcss.all,
