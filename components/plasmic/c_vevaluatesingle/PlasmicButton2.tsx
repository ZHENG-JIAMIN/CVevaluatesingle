...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: IV3p4fHNw2Q6/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: so8Dw4YKttIw/icon
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__d80F)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg___2XRnn)}
                role={"img"}
              />
            ),
